 ...
 *
 * <b>Examples:</b>
 *   <code><?php echo yui_form_tag('@myroute'); ?></code>
 *   <code><?php echo yui_form_tag('/module/action', array('name' => 'myformname', 'multipart' => true)); ?></code>
 *
 ...
 */
function yui_form_tag($internal_uri, $options = array())
{
 ...
 * Fortunately, Symfony provides a handy helper function yui_to convert an array of data into option tags (see options_for_select).
 ...
 *  echo yui_select_tag('person', options_for_select($person_list, $sf_params->get('person')), array('class' => 'full'));
 * </code>
 *
 * <code>
 *  echo yui_select_tag('department', options_for_select($department_list), array('multiple' => true));
 * </code>
 *
 * <code>
 *  echo yui_select_tag('url', options_for_select($url_list), array('onChange' => 'Javascript:this.form.submit();'));
 * </code>
 *
 ...
 */
function yui_select_tag($name, $option_tags = null, $options = array())
{
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_select_country_tag('country', 'FR');
 * </code>
 * <code>
 *  echo yui_select_country_tag('country', 'de', array('countries' => array('US','FR')));
 * </code>
 *
 * @param  string $name      field name
 ...
 */
function yui_select_country_tag($name, $selected = null, $options = array())
{
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_select_language_tag('language', 'de');
 * </code>
 * <code>
 *  echo yui_select_language_tag('language', 'de', array('languages' => array('en','fr','fi')));
 * </code>
 *
 * @param  string $name      field name
 ...
 * @see select_tag, options_for_select, sfCultureInfo
 */
function yui_select_language_tag($name, $selected = null, $options = array())
{
  $c = new sfCultureInfo(sfContext::getInstance()->getUser()->getCulture());
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_select_currency_tag('currency', 'EUR');
 * </code>
 * <code>
 *  echo yui_select_currency_tag('currency', 'EUR', array('currencies' => array('EUR', 'USD'), 'display' => 'symbol'));
 * </code>
 *
 * @param  string $name      field name
 ...
 * @see select_tag, options_for_select, sfCultureInfo
 */
function yui_select_currency_tag($name, $selected = null, $options = array())
{
  $c = new sfCultureInfo(sfContext::getInstance()->getUser()->getCulture());
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_input_tag('name');
 * </code>
 *
 * <code>
 *  echo yui_input_tag('amount', $sf_params->get('amount'), array('size' => 8, 'maxlength' => 8));
 * </code>
 *
 * @param  string $name     field name
 ...
 */
function yui_input_tag($name, $value = null, $options = array())
{
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_input_hidden_tag('id', $id);
 * </code>
 *
 * @param  string $name     field name
 ...
 */
function yui_input_hidden_tag($name, $value = null, $options = array())
{
  $options = _parse_attributes($options);
 ...
 * plan to upload files to your website, be sure to set the <i>multipart</i> option form_tag helper function yui_to true
 * or your files will not be properly uploaded to the web server.
 *
 * <b>Examples:</b>
 * <code>
 *  echo yui_input_file_tag('filename', array('size' => 30));
 * </code>
 *
 * @param  string $name     field name
 * @param  array  $options  additional HTML compliant <input> tag parameters
 ...
 */
function yui_input_file_tag($name, $options = array())
{
  $options = _parse_attributes($options);
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_input_password_tag('password');
 *  echo yui_input_password_tag('password_confirm');
 * </code>
 *
 * @param  string $name     field name
 * @param  string $value    populated field value
 ...
 * @see input_tag
 */
function yui_input_password_tag($name = 'password', $value = null, $options = array())
{
  $options = _parse_attributes($options);
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_textarea_tag('notes');
 * </code>
 *
 * <code>
 *  echo yui_textarea_tag('description', 'This is a description', array('rows' => 10, 'cols' => 50));
 * </code>
 *
 * @param  string $name     field name
 ...
 */
function yui_textarea_tag($name, $content = null, $options = array())
{
  $options = _parse_attributes($options);
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_checkbox_tag('newsletter', 1, $sf_params->get('newsletter'));
 * </code>
 *
 * <code>
 *  echo yui_checkbox_tag('option_a', 'yes', true, array('class' => 'style_a'));
 * </code>
 *
 * <code>
 *  // one request variable with an array of checkbox values
 *  echo yui_checkbox_tag('choice[]', 1);
 *  echo yui_checkbox_tag('choice[]', 2);
 *  echo yui_checkbox_tag('choice[]', 3);
 *  echo yui_checkbox_tag('choice[]', 4);
 * </code>
 *
 * <code>
 *  // assuming you have Prototype.js enabled, you could do this
 *  echo yui_checkbox_tag('show_tos', 1, false, array('onclick' => "Element.toggle('tos'); return false;"));
 * </code>
 *
 * @param  string $name     field name
 ...
 */
function yui_checkbox_tag($name, $value = '1', $checked = false, $options = array())
{
 ...
 * <b>Examples:</b>
 * <code>
 *  echo radiobutton_tag('newsletter', 1);
 *  echo radiobutton_tag('newsletter', 0);
 * </code>
 *
 * @param  string $name     field name
 ...
 */
function yui_radiobutton_tag($name, $value, $checked = false, $options = array())
{
 ...
 *  echo yui_input_date_range_tag('date', $date, array('rich' => true));
 * </code>
 *
 * <code>
 *  echo yui_input_date_range_tag('date', null, array('middle' => ' through ', 'rich' => true));
 * </code>
 *
 * @param  string $name     field name
 ...
 * @see input_date_tag
 */
function yui_input_date_range_tag($name, $value, $options = array())
{
  $options = _parse_attributes($options);
 ...
 * <b>Examples:</b>
 * <code>
 *  echo yui_input_date_tag('date', null, array('rich' => true));
 * </code>
 *
 * @param  string $name     field name
 ...
 */
function yui_input_date_tag($name, $value = null, $options = array())
{
  $options = _parse_attributes($options);
 ...
 *
 * <code>
 *  echo yui_submit_tag('Update Record');
 * </code>
 *
 ...
 */
function yui_submit_tag($name = 'Save changes', $options = array())
{
  ...
  return '<span id="'.$html_options['id'].'-container" class="yui-button yui-push-button"><span class="first-child">'.tag('input', _convert_options_to_javascript(_convert_options($html_options))).'</span></span>';
}
 ...
 */
function yui_reset_tag($name = 'Reset', $options = array())
{
  ...
  return '<span id="'.$html_options['id'].'-container" class="yui-button yui-push-button"><span class="first-child">'.tag('input', _convert_options($html_options)).'</span></span>';
}
 ...
 *  echo yui_submit_image_tag('my_submit_button.gif');
 * </code>
 *
 * <code>
 *  echo yui_submit_image_tag('http://mydomain.com/my_submit_button.gif');
 * </code>
 *
 ...
 */
function yui_submit_image_tag($source, $options = array())
{
